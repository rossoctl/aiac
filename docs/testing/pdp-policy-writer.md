...
> ([../PRD.md](../specs/PRD.md)) is the index of them. This is the **PDP Policy Writer (OPA)** integration
...
([../components/pdp-policy-writer-opa.md](../specs/components/pdp-policy-writer-opa.md) §1.14) rather than
...
[../components/pdp-policy-writer-opa.md](../specs/components/pdp-policy-writer-opa.md): input is IDs only
...
- **Prior art.** The stub itself and its unit tests (`test/unit/pdp/service/policy/opa/`,
...
([../PRD.md](../specs/PRD.md), § *Integration test specifications*). It is distinct from the
...
- The scenario is deliberately fixed. If the canonical worked example in
  [../components/pdp-policy-writer-opa.md](../specs/components/pdp-policy-writer-opa.md) changes, update the
