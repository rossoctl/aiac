...
- `test/unit/agent/policy_rules_builder/test_guardrail_conflicts.py` — Scenario 2.
- `test/unit/agent/policy_rules_builder/test_guardrail_injection.py` — Scenario 5.
- `test/unit/agent/policy_rules_builder/policy.eval_conflicts.md`,
...
docs/evaluation/policy-eval-scenarios.md")`:
...
`test/system/`, not under `eval/` like the other seven (see [Location](#location)). Scenarios
...
Same variables as [policy-pipeline.md](../testing/policy-pipeline.md#configuration-env) for the heavy
...
.venv/bin/pytest test/unit/agent/policy_rules_builder/test_guardrail_conflicts.py \
  test/unit/agent/policy_rules_builder/test_guardrail_injection.py -m llm -v
...
- **The Rego generator, the canonical policy model, the PRB, and the PCE implementations** —
  ...
  [../components/policy-model.md](../specs/components/policy-model.md),
  [../components/policy-computation-engine.md](../specs/components/policy-computation-engine.md)), not
...
Same pipeline prerequisites as [policy-pipeline.md](../testing/policy-pipeline.md#prerequisites) for the heavy
