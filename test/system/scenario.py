...
The 5.2 launcher (``test/unit/pdp/policy/generate_rego.py``) hand-builds a ``PolicyModel`` from
these names + role→access pair-sets; the 5.3 launcher (``test/system/policy_pipeline.py``)
...
consistent (spec: ``docs/testing/policy-pipeline.md``, *Scenario* +
*Scenario inputs*).
