...
Gating: the module is marked ``llm`` -> the hermetic default run deselects it (its collected count
is unchanged), and it can be selected on its own (``-m llm``) without a cluster or Keycloak. The
autouse
